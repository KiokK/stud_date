...
public class WorkerPayment extends JPanel{
    ...
    public WorkerPayment() {
        ...
        workerData_2array = new String[0][0];//getData("worker", "all");
        employerData_2array = new String[0][0];//getData("employer", "all");
    ...
    protected void paymentGUI(String worker) {
        ...
        titleWorker_label.setBounds(AdminPage.W_FRAME / 2 + 4, 60, AdminPage.W_FRAME / 2 - 4, 28);
        ...
        title_label.setBounds(0, 60, AdminPage.W_FRAME / 2 - 4, 28);
