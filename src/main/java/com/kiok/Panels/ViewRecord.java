...
public class ViewRecord extends JPanel{
    ...
    public ViewRecord() {
        ...
        employer_2array = new String[0][0];//listConvertToArray(DataBase.getData("employer"));
        employer_comboBox = new JComboBox<String>(listConvertToArray(new ArrayList<String[]>()/*DataBase.getData("employer")*/, 1, 2));
